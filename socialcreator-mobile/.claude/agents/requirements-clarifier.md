...
description: >-
  ...
  Context: The user is creating a requirements-clarifier agent that
  should be called when a task needs clarification before implementation.

  user: "Build me a user authentication system"

  assistant: "I'll delegate this to the requirements-clarifier agent to get
  ...
  Context: User is creating an agent to clarify requirements before
  implementation.
