  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, you can upgrade or downgrade your plan at any time. Changes take effect immediately and will be prorated.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can add additional profile slots at $20/month each from your billing settings.",
    },
    {
      question: "What happens if I exceed my profile limit?",
      answer:
        "You'll need to upgrade your plan to add more profiles. Existing profiles will continue to work.",
    },
    {
      question: "Is there a free trial?",
      answer:
        "Yes! New accounts start with 1 free profile. No credit card required to get started.",
    },
  ];
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative max-w-content mx-auto px-6 py-section">
        ...
        {/* Features comparison */}
        <div className="mb-16">
          <h2 className="text-title-md text-center mb-8">Everything you need to scale</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-xl border border-hairline bg-surface-card p-6">
              ...
              <p className="text-body-sm text-muted">
                Track performance across all platforms with detailed insights and engagement
                metrics.
              </p>
            </div>
          </div>
        ...
        {/* FAQ */}
        <div>
          <h2 className="text-title-md text-center mb-8">Frequently asked questions</h2>
        ...
        <div className="text-center mt-16">
          <p className="text-body-sm text-muted mb-4">Still have questions?</p>
          <a
