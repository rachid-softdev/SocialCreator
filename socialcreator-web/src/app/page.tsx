...
export default function Home() {
  ...
  return (
    <main>
      <NavTop links={navLinks} cta={{ href: "/login", label: "Try Free" }} />
      ...
      <section className="relative overflow-hidden bg-canvas px-xxl py-section">
        <div className="mx-auto max-w-content text-center">
          <GradientOrb
            color="mint"
            className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/4 blur-[80px]"
          />
          ...
          <p className="mx-auto mt-lg max-w-xl font-sans text-body-md text-body">
            SocialCreator uses AI agents to generate, schedule, and publish social media content
            that sounds like you—on autopilot.
          </p>
      ...
      <section id="features" className="bg-canvas-soft px-xxl py-section">
        <div className="mx-auto max-w-content">
          <h2 className="font-display text-display-lg text-ink">Built for modern brands</h2>
