...
export function VideoCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "relative bg-surface-card rounded-xl overflow-hidden border border-hairline cursor-pointer transition-all duration-200 hover:shadow-card",
        className,
      )}
    >
      ...
      <div className="p-3">
        <div className="flex items-center justify-between">
          <span
            className={cn(
              "px-2 py-0.5 rounded-pill text-caption-uppercase text-xs font-semibold",
              statusColor,
            )}
          >
            {statusLabel}
